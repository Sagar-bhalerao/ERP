...
import { handleToDept } from "../../../features/Gatepass/gatepassSlice";
...
const ModalToDept = () => {
  ...
  const handleSelect = (item: any) => {
    dispatch(handleToDept({ id: item.dept_id, name: item.dept_name }));
    (document.getElementById("ToDeptModal") as HTMLDialogElement).close();
  }

  return (
    <dialog id="ToDeptModal" className="modal">
      hello
      <div className="modal-box">
        <button
          onClick={() => (document.getElementById("ToDeptModal") as HTMLDialogElement)?.close()}
