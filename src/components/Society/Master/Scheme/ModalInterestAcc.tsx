...
import { handleSelectScheme } from "../../../../features/Society/SocietySlice"
const ModalInterestAcc = () => {
    ...
    const handleSelect = (item: any) => {
        (document.getElementById("interestModal")as HTMLDialogElement).close();
        dispatch(handleSelectScheme({  id: item.acc_code, name: item.account_name, }))
       
        
  }
    return (
        <>
            <dialog id="interestModal" className="modal">
                <div className="modal-box">
                    <button
                        onClick={() => (document.getElementById("interestModal") as HTMLDialogElement)?.close()}
...
export default ModalInterestAcc;
