                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                            <div className="w-10 rounded-full">
                                {isAuthenticated ? (<><span className="flex justify-center bg-black  dark:text-white text-2xl">{name.firstname.toUpperCase().charAt(0) + name.lastname.toUpperCase().charAt(0)}</span></>) : (<><div className=""><IoPersonCircleOutline size={47} className="w-10 mt-[-3px] bg-primary text-gray-50 " /></div></>)}
