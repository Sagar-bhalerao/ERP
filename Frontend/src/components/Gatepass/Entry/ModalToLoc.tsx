...
import { handleToLoc } from "../../../features/Gatepass/gatepassSlice";
...
const ModalToLoc = () => {
  ...
  const handleSelect = (item: any) => {
    dispatch(handleToLoc({ id: item.loc_id, name: item.loc_name }));
    (document.getElementById("TLocModal") as HTMLDialogElement).close();
  }

  return (
    <dialog id="TLocModal" className="modal">
      hello
      <div className="modal-box">
        <button
          onClick={() => (document.getElementById("TLocModal") as HTMLDialogElement)?.close()}
